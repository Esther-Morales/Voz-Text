...
from codificador.inference import plot_embedding_as_heatmap
...
#Es la bienvenida para la caja de texto 
default_text = \
    "Welcome to the toolbox! To get started, write whatever you want" \
      "in this toolbox.\n Find the audio of your choice.\n" \
      "The synthesizer expects to generate " \
      "outputs that last between 5 and 12 seconds.\nTo mark pauses, write a new line." \
      "Each line will be treated separately.\nThen they will be joined to make the end" \
      "spectrogram. Use the vocoder to generate audio.\nLoad or save more expressions to view.\nIf you have " \
      "at least 2 or 3 statements from the same speaker, a group must be formed.\nSynthesized" \
      "expressions are the same color as the speaker whose voice was used, but they are"\
...
class UI(QDialog):
    ...
    def draw_umap_projections(self, utterances: Set[Utterance]):
        ...
        # Mostrar un mensaje si no hay suficientes puntos
    ...
    def save_audio_file(self, wav, sample_rate):
        ...
        if fpath:
            # El formato predeterminado es wav
    ...
    def setup_audio_devices(self, sample_rate):
        ...
        for device in sd.query_devices():
            ...
            # Comprobar si la salida es válida
            try:
                sd.check_output_settings(device=device["name"], samplerate=sample_rate)
                output_devices.append(device["name"])
            except Exception as e:
                # Registrar una advertencia solo si el dispositivo no es una entrada
    ...
    def set_audio_device(self):
        ...
        # Si no hay ninguno, el dispositivo de sonido consulta portaudio
    ...
    def populate_browser(self, datasets_root: Path, recognized_datasets: List, level: int,
        ...
        # Seleccionar un altavoz al azar
        if level <= 1:
    ...
    def __init__(self):
      ## Inicializar la aplicación
       ...
       # visualizaciones
        ...
        ## Caja de Projections
        # UMap
        fig, self.umap_ax = plt.subplots(figsize=(3, 3), facecolor="#F0F0F0") #F0F0F0
        ...
        ## Navegador 
        # Selección de conjuntos de datos, hablantes y expresiones
        i = 0
       ...
       # Botones aleatorios
        ...
        # Botones aleatorios y de siguiente expresión
        ...
        # Selección de modelo y salida de audio
        self.encoder_box = QComboBox()
        browser_layout.addWidget(QLabel("<b>Codificadora</b>"), i, 0)
        browser_layout.addWidget(self.encoder_box, i + 1, 0)
        self.synthesizer_box = QComboBox()
        browser_layout.addWidget(QLabel("<b>Sintetizador</b>"), i, 1)
        browser_layout.addWidget(self.synthesizer_box, i + 1, 1)
        self.vocoder_box = QComboBox()
        browser_layout.addWidget(QLabel("<b>Codificador/Voz</b>"), i, 2)
        browser_layout.addWidget(self.vocoder_box, i + 1, 2)

        self.audio_out_devices_cb=QComboBox()
        browser_layout.addWidget(QLabel("<b>Salida de Audio</b>"), i, 3)
        ...
        for ax in self.current_ax.tolist() + self.gen_ax.tolist():
            ax.set_facecolor("#F0F0F0") # F0F0F0
        ...
        self.trim_silences_checkbox = QCheckBox("Mejore la salida del vocoder")
        ...
        ## Establecer el tamaño de la ventana y de los elementos.
